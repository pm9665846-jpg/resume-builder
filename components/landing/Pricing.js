  ...
  return (
    <section
      ...
      style={{
        ...
        padding: '100px 0',
        background:
          'radial-gradient(circle at top center, rgba(139,92,246,0.08), transparent 35%), #050508',
        position: 'relative',
        overflow: 'hidden',
      }}
    >
              ...
              return (
                <button
                  ...
                  style={{
                    ...
                    boxShadow: active ? '0 8px 20px rgba(139,92,246,0.25)' : 'none',
                  }}
                >
                  {label}
                  {i === 1 && (
              ...
              <motion.div
                ...
                style={{
                  background: plan.popular
                    ? 'linear-gradient(180deg, rgba(139,92,246,0.12), rgba(255,255,255,0.04))'
              ...
              >
                ...
                >
                  ...
                  {yearly && plan.price.monthly > 0 ? (
                    ...
                    >
                      Save ₹{savings.toLocaleString('en-IN')}/year with yearly billing
                    </p>
                  ) : (
                    <p
                      style={{
                    ...
                    >
                      {plan.price.monthly === 0 ? 'No credit card required' : 'Cancel anytime'}
                    </p>
                  )}
                </div>
                ...
                <Link
                  ...
                  onMouseEnter={(e) => {
                    ...
                    e.currentTarget.style.boxShadow = plan.popular
                      ? '0 16px 36px rgba(139,92,246,0.35)'
